MyStaticPagede_adm是在StaticPagede基础上修改的 AMD静态页面自动化工具
==========
...
````
git clone https://github.com/TonyXY/MyStaticPage_adm.git && cd StaticPage && sh go.sh
````
...
````
git clone https://github.com/TonyXY/MyStaticPage_adm.git
````
